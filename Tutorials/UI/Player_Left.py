...
from constant import KEY_ACTION_LEFT_MAPPING, LINK_SHINOBI_LEFT
...
class Player_Left(pygame.sprite.Sprite):
    ...
    def load_animations(self):
        for action in KEY_ACTION_LEFT_MAPPING.values():
    ...
    def create_slash(self):
        ...
        slash_ins = Slash(ANIMATION_SLASH_SPEED, self.link_slash, self.n, x_pos, y_pos, 'left')
